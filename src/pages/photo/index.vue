      ...
      <scroll-view :height="contentHeight" :pullup="true" @scrollToEnd="onPullup">
        <div class="waterfall">
          <water-fall :options="vfOptions">
            <div class="waterfall__item" v-for="(item, idx) in vfOptions.data" :key="idx">
